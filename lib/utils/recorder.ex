defmodule SmartTracer.Utils.Recorder do
  ...
  defp build_record({:call, {module, func_name, args, erl_ts}}) do
    %SmartTracer.Utils.Recorder.Call{
      ...
      datetime: get_datetime(erl_ts)
    }
  end

  defp build_record({:return, {module, func_name, arity, return_value, erl_ts}}) do
